...
DSP is a vast, complex area but even simple signal processing techniques like those covered in this lesson are helpful. If you'd like to dive deeper into DSP, see our {% include tlink.html id='signals-signal-processing' text='Signal Processing' %} lessons, which introduce {% include tlink.html id='signals-quantization-and-sampling' text='quantization and sampling' %}, {% include tlink.html id='signals-comparing-signals' text='signal comparisons' %}, and {% include tlink.html id='signals-frequency-analysis' text='frequency analysis' %}. For a more technical introduction to digital filters, see [Chapter 14: Introduction to Digital Filters](http://www.dspguide.com/ch14/1.htm) in Steven W. Smith's book [The Scientist and Engineer's Guide to Digital Signal Processing](http://www.dspguide.com/). We also recommend Jack Schaelder's [interactive primer on DSP](https://jackschaedler.github.io/circles-sines-signals/index.html).
...
For your prototyping activity, we would like you to choose a sensor from your hardware kits—it could be a {% include tlink.html id='arduino-potentiometers' text='potentiometer' %}, a {% include tlink.html id='sensors-hall-effect' text='hall effect sensor' %}, a {% include tlink.html id='arduino-force-sensitive-resistors' text='force-sensitive resistor' %}, a {% include tlink.html id='sensors-photoresistors' text='photoresistor' %}, an {% include tlink.html id='sensors-accelerometers' text='accelerometer' %}, a DIY sensor, *etc.*—and **two** different smoothing algorithms to apply to it.

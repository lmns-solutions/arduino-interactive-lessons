...
![[]({{ "/assets/images/Verschiedene_LEDs_FromWikipedia.jpg" | relative_url }})
...
<video autoplay loop muted playsinline style="margin:0px">
  <source src="{{ "/assets/videos/DiodeOnlyWorksInOneDirection_CircuitJS_ByJonFroehlich.mp4" | relative_url }}" type="video/mp4" />
</video>
...
![[]({{ "/assets/images/DiodeSymbolAnd1N4002Picture_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/DiodeWaterTrapdoorAnalogy.png" | relative_url }})
...
![[]({{ "/assets/images/CurrentVoltageGraphsDiodes_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/CurrentVoltageGraphDiodeSimplication2_JonFroehlichAndUIUCECE110.png" | relative_url }})
...
![[]({{ "/assets/images/ResistorDiodeCircuit_SolveForCurrentI_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/ResistorDiodeCircuit_SolveForCurrentI_Step1_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/ResistorDiodeCircuit_SolveForCurrentI_Step2_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/ResistorDiodeCircuit_SolveForCurrentI_Step3_ByJonFroehlich.png" | relative_url }})
...
<video autoplay loop muted playsinline style="margin:0px">
  <source src="{{ "/assets/videos/DiodeResistorCircuitBasic_CircuitJS_ByJonFroehlich.mp4" | relative_url }}" type="video/mp4" />
</video>
...
![[]({{ "/assets/images/ResistorDiodeCircuit_SolveForCurrentI_Step4_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/1N4001DataSheet_PowerDissipationRating_FairchildSemiconductor.png" | relative_url }})
...
![[]({{ "/assets/images/LEDBasedProjects.png" | relative_url }})
...
![[]({{ "/assets/images/LEDSymbolAndPartsLabeled_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/InsideAnLED_ModifiedImageFromTubeTimeUS.png" | relative_url }})
...
![[]({{ "/assets/images/IVCurves_FromLEDnique.com.png" | relative_url }})
...
![[]({{ "/assets/images/IVCurveZoomIn_FromLEDnique.com.png" | relative_url }})
...
![[]({{ "/assets/images/IVCurveExperiments_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/IVCurveExperiments_GraphPlusRedLEDPictures_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/ScreenshotOfTheRedLEDDatasheet-C53-002_Fedy_FD-5AR35-1.pdf.png.png" | relative_url }})
...
![[]({{ "/assets/images/SolveForResistor_LEDCircuit_Step0_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/SolveForResistor_LEDCircuit_Step1_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/SolveForResistor_LEDCircuit_Step2_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/SolveForResistor_LEDCircuit_Step3_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/SolveForResistor_LEDCircuit_Step4_ByJonFroehlich.png" | relative_url }})
...
![[]({{ "/assets/images/SolveForResistor_LEDCircuit_330Or470Ohm.png" | relative_url }})
...
![[]({{ "/assets/images/SolveForResistor_LEDCircuit_UseResistorEquivalanceRules.png" | relative_url }})
...
<video autoplay loop muted playsinline style="margin:0px">
  <source src="{{ "/assets/videos/ThreeLEDCircuitsWithDifferentCurrentLimitingResistors_CircuitJS.mp4" | relative_url }}" type="video/mp4" />
</video>
...
![[]({{ "/assets/images/SolveForResistor_LEDCircuit_PhysicalBuildsOf330Ohm350OhmAnd470Ohm.png" | relative_url }})
...
<video autoplay loop muted playsinline style="margin:0px">
  <source src="{{ "/assets/videos/ResistorBeforeOrAfterTheLED_CircuitJS.mp4" | relative_url }}" type="video/mp4" />
</video>
...
<video autoplay loop muted playsinline style="margin:0px">
  <source src="{{ "/assets/videos/LEDBurnOut_Afrotechmods_Trimmed.mp4" | relative_url }}" type="video/mp4" />
</video>
...
<video autoplay loop muted playsinline style="margin:0px">
  <source src="{{ "/assets/videos/WireWrapAnLED_ByJonFroehlich.mp4" | relative_url }}" type="video/mp4" />
</video>
...
![[]({{ "/assets/images/SimpleLEDCircuitWithWireWrapping_ByJonFroehlich.png" | relative_url }})
...
<video autoplay loop muted playsinline style="margin:0px">
  <source src="{{ "/assets/videos/StarWars_SimpleToiletRollLightSabers_ByJonFroehlich.mp4" | relative_url }}" type="video/mp4" />
</video>
